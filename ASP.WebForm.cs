...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        string from = "sena.fred@gmail.com"; //Replace this with your own correct Gmail Address
        string to = "sena.fred@gmail.com"; //Replace this with the Email Address to whom you want to send the mail

        System.Net.Mail.MailMessage mail = new System.Net.Mail.MailMessage();
        mail.To.Add(to);
        mail.From = new MailAddress(from, "GestaoFinanceira FredKeyla", System.Text.Encoding.UTF8);
        mail.Subject = "Erro: Sistema Gestão Financeira FredKeyla";
        ...
        client.Credentials = new System.Net.NetworkCredential(from, "3gostoD&#Etcak");
