...
function KeyDownHandler(maskExtenderId) {
    if (navigator.appName != "Microsoft Internet Explorer") {
        ...
        if (event.keyCode == 8 || event.keyCode == 46) {
            ...
            var maskExtender = $(maskExtenderId);
            ...
            {
                if (txtElementCursorPosition >= 0 && txtElementCursorPosition < txtElementText.length && ((selectedSymbols <= 1 && txtElementText[txtElementCursorPosition] != "_") || selectedSymbols > 1)) {
